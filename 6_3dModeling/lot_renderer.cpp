...
namespace lot {
    ...
    void LotRenderer::freeCommandBuffer() {
    ...
    VkCommandBuffer LotRenderer::beginFrame() {
        assert(!isFrameStarted && "Can't call beginFrame while frame is not in progress");
